...
//------------------------------------------------------------------------------
static uint32_t ADDR_GPIO    =0xC0050000;
static uint32_t CSRA_VERSION =0xC0050000+0x00;
static uint32_t CSRA_NAME    =0xC0050000+0x04;
static uint32_t CSRA_DIR     =0xC0050000+0x10;
static uint32_t CSRA_INPUT   =0xC0050000+0x14;
static uint32_t CSRA_OUTPUT  =0xC0050000+0x18;
static uint32_t CSRA_MASK    =0xC0050000+0x1C;
static uint32_t CSRA_IRQ     =0xC0050000+0x20;
static uint32_t CSRA_EDGE    =0xC0050000+0x24;
static uint32_t CSRA_POL     =0xC0050000+0x28;
...
void gpio_csr(void)
{
     ...
     CSR_READ(CSRA_VERSION, dataR); printf("GPIO VERSION: 0x%08X\n", dataR);
     CSR_READ(CSRA_NAME   , dataR); printf("GPIO NAME   : 0x%08X\n", dataR);
     CSR_READ(CSRA_DIR    , dataR); printf("GPIO DIR    : 0x%08X\n", dataR);
     CSR_READ(CSRA_INPUT  , dataR); printf("GPIO INPUT  : 0x%08X\n", dataR);
     CSR_READ(CSRA_OUTPUT , dataR); printf("GPIO OUTPUT : 0x%08X\n", dataR);
     CSR_READ(CSRA_MASK   , dataR); printf("GPIO MASK   : 0x%08X\n", dataR);
     CSR_READ(CSRA_IRQ    , dataR); printf("GPIO IRQ    : 0x%08X\n", dataR);
     CSR_READ(CSRA_EDGE   , dataR); printf("GPIO EDGE   : 0x%08X\n", dataR);
     CSR_READ(CSRA_POL    , dataR); printf("GPIO POL    : 0x%08X\n", dataR);
}
