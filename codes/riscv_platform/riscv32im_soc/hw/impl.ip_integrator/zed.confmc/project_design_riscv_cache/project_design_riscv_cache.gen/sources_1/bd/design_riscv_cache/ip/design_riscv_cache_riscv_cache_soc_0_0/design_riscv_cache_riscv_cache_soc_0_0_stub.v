...
// Date        : Wed Nov 26 10:29:06 2025
// Host        : sogang-500TGA-500SGA running 64-bit Ubuntu 22.04.5 LTS
// Command     : write_verilog -force -mode synth_stub
//               /home/sogang/pjt/team2/codes/riscv_platform/riscv32im_soc/hw/impl.ip_integrator/zed.confmc/project_design_riscv_cache/project_design_riscv_cache.gen/sources_1/bd/design_riscv_cache/ip/design_riscv_cache_riscv_cache_soc_0_0/design_riscv_cache_riscv_cache_soc_0_0_stub.v
...
module design_riscv_cache_riscv_cache_soc_0_0(uart_txd, uart_rxd, uart_rts_n, uart_cts_n, 
  gpio_in, gpio_out, keypad_col, keypad_row, i2c_sda, i2c_scl, cpu_resetn, spi_cs_n, spi_sck, 
  spi_mosi, spi_miso, spi_rst, axi_aresetn, axi_aclk, s_axi_confmc_awid, s_axi_confmc_awaddr, 
  s_axi_confmc_awlen, s_axi_confmc_awsize, s_axi_confmc_awburst, s_axi_confmc_awvalid, 
  s_axi_confmc_awready, s_axi_confmc_wdata, s_axi_confmc_wstrb, s_axi_confmc_wlast, 
  s_axi_confmc_wvalid, s_axi_confmc_wready, s_axi_confmc_bid, s_axi_confmc_bresp, 
  s_axi_confmc_bvalid, s_axi_confmc_bready, s_axi_confmc_arid, s_axi_confmc_araddr, 
  s_axi_confmc_arlen, s_axi_confmc_arsize, s_axi_confmc_arburst, s_axi_confmc_arvalid, 
  s_axi_confmc_arready, s_axi_confmc_rid, s_axi_confmc_rdata, s_axi_confmc_rresp, 
  s_axi_confmc_rlast, s_axi_confmc_rvalid, s_axi_confmc_rready, m_axi_mem_awid, 
  m_axi_mem_awaddr, m_axi_mem_awlen, m_axi_mem_awsize, m_axi_mem_awburst, 
